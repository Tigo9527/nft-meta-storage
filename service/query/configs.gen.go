...
func newConfig(db *gorm.DB, opts ...gen.DOOption) config {
	...
	_config.configDo.UseModel(&db_models.Config{})
...
type IConfigDo interface {
	...
	Unscoped() IConfigDo
	Create(values ...*db_models.Config) error
	CreateInBatches(values []*db_models.Config, batchSize int) error
	Save(values ...*db_models.Config) error
	First() (*db_models.Config, error)
	Take() (*db_models.Config, error)
	Last() (*db_models.Config, error)
	Find() ([]*db_models.Config, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*db_models.Config, err error)
	FindInBatches(result *[]*db_models.Config, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*db_models.Config) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*db_models.Config, error)
	FirstOrCreate() (*db_models.Config, error)
	FindByPage(offset int, limit int) (result []*db_models.Config, count int64, err error)
...
func (c configDo) Create(values ...*db_models.Config) error {
	if len(values) == 0 {
		return nil
	}
...
func (c configDo) CreateInBatches(values []*db_models.Config, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c configDo) Save(values ...*db_models.Config) error {
	if len(values) == 0 {
		return nil
	}
...
func (c configDo) First() (*db_models.Config, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*db_models.Config), nil
	}
}

func (c configDo) Take() (*db_models.Config, error) {
...
func (c configDo) Last() (*db_models.Config, error) {
...
func (c configDo) Find() ([]*db_models.Config, error) {
	result, err := c.DO.Find()
	return result.([]*db_models.Config), err
}

func (c configDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*db_models.Config, err error) {
	buf := make([]*db_models.Config, 0, batchSize)
...
func (c configDo) FindInBatches(result *[]*db_models.Config, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c configDo) FirstOrInit() (*db_models.Config, error) {
...
func (c configDo) FirstOrCreate() (*db_models.Config, error) {
...
func (c configDo) FindByPage(offset int, limit int) (result []*db_models.Config, count int64, err error) {
...
func (c configDo) Delete(models ...*db_models.Config) (result gen.ResultInfo, err error) {
