...
func newMigration(db *gorm.DB, opts ...gen.DOOption) migration {
	...
	_migration.migrationDo.UseModel(&db_models.Migration{})
	...
	_migration.Addr = field.NewString(tableName, "addr")
	_migration.ChainRpc = field.NewString(tableName, "chain_rpc")
	_migration.TotalSupply = field.NewInt(tableName, "total_supply")
	_migration.DownloadedMeta = field.NewInt(tableName, "downloaded_meta")
	_migration.Status = field.NewString(tableName, "status")
	_migration.ImageFileEntryId = field.NewInt(tableName, "image_file_entry_id")
	_migration.MetaFileEntryId = field.NewInt(tableName, "meta_file_entry_id")
	_migration.ImageUploaded = field.NewBool(tableName, "image_uploaded")
	_migration.MetaUploaded = field.NewBool(tableName, "meta_uploaded")
	_migration.Name = field.NewString(tableName, "name")
	_migration.CreatedAt = field.NewTime(tableName, "created_at")
	_migration.UpdatedAt = field.NewTime(tableName, "updated_at")
...
type migration struct {
	...
	Id               field.Int64
	Addr             field.String
	ChainRpc         field.String
	TotalSupply      field.Int
	DownloadedMeta   field.Int
	Status           field.String
	ImageFileEntryId field.Int
	MetaFileEntryId  field.Int
	ImageUploaded    field.Bool
	MetaUploaded     field.Bool
	Name             field.String
...
func (m *migration) updateTableName(table string) *migration {
	...
	m.ChainRpc = field.NewString(table, "chain_rpc")
	m.TotalSupply = field.NewInt(table, "total_supply")
	m.DownloadedMeta = field.NewInt(table, "downloaded_meta")
	m.Status = field.NewString(table, "status")
	m.ImageFileEntryId = field.NewInt(table, "image_file_entry_id")
	m.MetaFileEntryId = field.NewInt(table, "meta_file_entry_id")
	m.ImageUploaded = field.NewBool(table, "image_uploaded")
	m.MetaUploaded = field.NewBool(table, "meta_uploaded")
...
func (m *migration) fillFieldMap() {
	...
	m.fieldMap["chain_rpc"] = m.ChainRpc
	m.fieldMap["total_supply"] = m.TotalSupply
	m.fieldMap["downloaded_meta"] = m.DownloadedMeta
	m.fieldMap["status"] = m.Status
	m.fieldMap["image_file_entry_id"] = m.ImageFileEntryId
	m.fieldMap["meta_file_entry_id"] = m.MetaFileEntryId
	m.fieldMap["image_uploaded"] = m.ImageUploaded
	m.fieldMap["meta_uploaded"] = m.MetaUploaded
...
type IMigrationDo interface {
	...
	Create(values ...*db_models.Migration) error
	CreateInBatches(values []*db_models.Migration, batchSize int) error
	Save(values ...*db_models.Migration) error
	First() (*db_models.Migration, error)
	Take() (*db_models.Migration, error)
	Last() (*db_models.Migration, error)
	Find() ([]*db_models.Migration, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*db_models.Migration, err error)
	FindInBatches(result *[]*db_models.Migration, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*db_models.Migration) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*db_models.Migration, error)
	FirstOrCreate() (*db_models.Migration, error)
	FindByPage(offset int, limit int) (result []*db_models.Migration, count int64, err error)
...
func (m migrationDo) Create(values ...*db_models.Migration) error {
	if len(values) == 0 {
		return nil
	}
...
func (m migrationDo) CreateInBatches(values []*db_models.Migration, batchSize int) error {
	return m.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (m migrationDo) Save(values ...*db_models.Migration) error {
	if len(values) == 0 {
		return nil
	}
...
func (m migrationDo) First() (*db_models.Migration, error) {
	if result, err := m.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*db_models.Migration), nil
	}
}

func (m migrationDo) Take() (*db_models.Migration, error) {
...
func (m migrationDo) Last() (*db_models.Migration, error) {
...
func (m migrationDo) Find() ([]*db_models.Migration, error) {
	result, err := m.DO.Find()
	return result.([]*db_models.Migration), err
}

func (m migrationDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*db_models.Migration, err error) {
	buf := make([]*db_models.Migration, 0, batchSize)
...
func (m migrationDo) FindInBatches(result *[]*db_models.Migration, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (m migrationDo) FirstOrInit() (*db_models.Migration, error) {
...
func (m migrationDo) FirstOrCreate() (*db_models.Migration, error) {
...
func (m migrationDo) FindByPage(offset int, limit int) (result []*db_models.Migration, count int64, err error) {
...
func (m migrationDo) Delete(models ...*db_models.Migration) (result gen.ResultInfo, err error) {
