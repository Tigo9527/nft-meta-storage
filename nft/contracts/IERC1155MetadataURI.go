...
// IERC1155MetadataURI is an auto generated Go binding around an Conflux contract.
...
// IERC1155MetadataURICaller is an auto generated read-only Go binding around an Conflux contract.
type IERC1155MetadataURICaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// IERC1155MetadataURIBulkCaller is an auto generated read-only Go binding around an Conflux contract.
type IERC1155MetadataURIBulkCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// IERC1155MetadataURITransactor is an auto generated write-only Go binding around an Conflux contract.
type IERC1155MetadataURITransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// IERC1155MetadataURIBulkTransactor is an auto generated write-only Go binding around an Conflux contract.
type IERC1155MetadataURIBulkTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// IERC1155MetadataURIFilterer is an auto generated log filtering Go binding around an Conflux contract events.
type IERC1155MetadataURIFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// IERC1155MetadataURISession is an auto generated Go binding around an Conflux contract,
...
// IERC1155MetadataURICallerSession is an auto generated read-only Go binding around an Conflux contract,
...
// IERC1155MetadataURITransactorSession is an auto generated write-only Go binding around an Conflux contract,
...
// IERC1155MetadataURIRaw is an auto generated low-level Go binding around an Conflux contract.
type IERC1155MetadataURIRaw struct {
	Contract *IERC1155MetadataURI // Generic contract binding to access the raw methods on
}

// IERC1155MetadataURICallerRaw is an auto generated low-level read-only Go binding around an Conflux contract.
...
// IERC1155MetadataURITransactorRaw is an auto generated low-level write-only Go binding around an Conflux contract.
...
func NewIERC1155MetadataURI(address types.Address, backend bind.ContractBackend) (*IERC1155MetadataURI, error) {
...
func NewIERC1155MetadataURICaller(address types.Address, caller bind.ContractCaller) (*IERC1155MetadataURICaller, error) {
...
func NewIERC1155MetadataURITransactor(address types.Address, transactor bind.ContractTransactor) (*IERC1155MetadataURITransactor, error) {
...
func NewIERC1155MetadataURIFilterer(address types.Address, filterer bind.ContractFilterer) (*IERC1155MetadataURIFilterer, error) {
...
// NewIERC1155MetadataURICaller creates a new read-only instance of IERC1155MetadataURI, bound to a specific deployed contract.
func NewIERC1155MetadataURIBulkCaller(address types.Address, caller bind.ContractCaller) (*IERC1155MetadataURIBulkCaller, error) {
	contract, err := bindIERC1155MetadataURI(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &IERC1155MetadataURIBulkCaller{contract: contract}, nil
}

// NewIERC1155MetadataURIBulkTransactor creates a new write-only instance of IERC1155MetadataURI, bound to a specific deployed contract.
func NewIERC1155MetadataURIBulkTransactor(address types.Address, transactor bind.ContractTransactor) (*IERC1155MetadataURIBulkTransactor, error) {
	contract, err := bindIERC1155MetadataURI(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &IERC1155MetadataURIBulkTransactor{contract: contract}, nil
}

// bindIERC1155MetadataURI binds a generic wrapper to an already deployed contract.
func bindIERC1155MetadataURI(address types.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
...
func (_IERC1155MetadataURI *IERC1155MetadataURIRaw) Transfer(opts *bind.TransactOpts) (*types.UnsignedTransaction, *types.Hash, error) {
	return _IERC1155MetadataURI.Contract.IERC1155MetadataURITransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_IERC1155MetadataURI *IERC1155MetadataURIRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.UnsignedTransaction, *types.Hash, error) {
...
// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_IERC1155MetadataURI *IERC1155MetadataURITransactorRaw) Transfer(opts *bind.TransactOpts) (*types.UnsignedTransaction, *types.Hash, error) {
	return _IERC1155MetadataURI.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_IERC1155MetadataURI *IERC1155MetadataURITransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.UnsignedTransaction, *types.Hash, error) {
...
func (_IERC1155MetadataURI *IERC1155MetadataURICaller) BalanceOf(opts *bind.CallOpts, account common.Address, id *big.Int) (*big.Int, error) {
	var out []interface{}
	__err := _IERC1155MetadataURI.contract.Call(opts, &out, "balanceOf", account, id)
...
//
// Solidity: function balanceOf(address account, uint256 id) view returns(uint256)
func (_IERC1155MetadataURI *IERC1155MetadataURIBulkCaller) BalanceOf(bulkcaller bulk.BulkCaller, opts *bind.CallOpts, account common.Address, id *big.Int) (**big.Int, *error) {

	if opts == nil {
		opts = new(bind.CallOpts)
	}
	__request := _IERC1155MetadataURI.contract.GenRequest(opts, "balanceOf", account, id)
	...
	outDecoder := func(rawOut []byte) error {
		out := []interface{}{}
		err := _IERC1155MetadataURI.contract.DecodeOutput(&out, rawOut, "balanceOf")
		if err != nil {
			return err
		}
...
func (_IERC1155MetadataURI *IERC1155MetadataURICaller) BalanceOfBatch(opts *bind.CallOpts, accounts []common.Address, ids []*big.Int) ([]*big.Int, error) {
	var out []interface{}
	__err := _IERC1155MetadataURI.contract.Call(opts, &out, "balanceOfBatch", accounts, ids)
...
//
// Solidity: function balanceOfBatch(address[] accounts, uint256[] ids) view returns(uint256[])
func (_IERC1155MetadataURI *IERC1155MetadataURIBulkCaller) BalanceOfBatch(bulkcaller bulk.BulkCaller, opts *bind.CallOpts, accounts []common.Address, ids []*big.Int) (*[]*big.Int, *error) {

	if opts == nil {
		opts = new(bind.CallOpts)
	}
	__request := _IERC1155MetadataURI.contract.GenRequest(opts, "balanceOfBatch", accounts, ids)
	...
	outDecoder := func(rawOut []byte) error {
		out := []interface{}{}
		err := _IERC1155MetadataURI.contract.DecodeOutput(&out, rawOut, "balanceOfBatch")
		if err != nil {
			return err
		}
...
func (_IERC1155MetadataURI *IERC1155MetadataURICaller) IsApprovedForAll(opts *bind.CallOpts, account common.Address, operator common.Address) (bool, error) {
	var out []interface{}
	__err := _IERC1155MetadataURI.contract.Call(opts, &out, "isApprovedForAll", account, operator)
...
//
// Solidity: function isApprovedForAll(address account, address operator) view returns(bool)
func (_IERC1155MetadataURI *IERC1155MetadataURIBulkCaller) IsApprovedForAll(bulkcaller bulk.BulkCaller, opts *bind.CallOpts, account common.Address, operator common.Address) (*bool, *error) {

	if opts == nil {
		opts = new(bind.CallOpts)
	}
	__request := _IERC1155MetadataURI.contract.GenRequest(opts, "isApprovedForAll", account, operator)
	...
	outDecoder := func(rawOut []byte) error {
		out := []interface{}{}
		err := _IERC1155MetadataURI.contract.DecodeOutput(&out, rawOut, "isApprovedForAll")
		if err != nil {
			return err
		}
...
func (_IERC1155MetadataURI *IERC1155MetadataURICaller) SupportsInterface(opts *bind.CallOpts, interfaceId [4]byte) (bool, error) {
	var out []interface{}
	__err := _IERC1155MetadataURI.contract.Call(opts, &out, "supportsInterface", interfaceId)
...
//
// Solidity: function supportsInterface(bytes4 interfaceId) view returns(bool)
func (_IERC1155MetadataURI *IERC1155MetadataURIBulkCaller) SupportsInterface(bulkcaller bulk.BulkCaller, opts *bind.CallOpts, interfaceId [4]byte) (*bool, *error) {

	if opts == nil {
		opts = new(bind.CallOpts)
	}
	__request := _IERC1155MetadataURI.contract.GenRequest(opts, "supportsInterface", interfaceId)
	...
	outDecoder := func(rawOut []byte) error {
		out := []interface{}{}
		err := _IERC1155MetadataURI.contract.DecodeOutput(&out, rawOut, "supportsInterface")
		if err != nil {
			return err
		}
...
func (_IERC1155MetadataURI *IERC1155MetadataURICaller) Uri(opts *bind.CallOpts, id *big.Int) (string, error) {
	var out []interface{}
	__err := _IERC1155MetadataURI.contract.Call(opts, &out, "uri", id)
...
//
// Solidity: function uri(uint256 id) view returns(string)
func (_IERC1155MetadataURI *IERC1155MetadataURIBulkCaller) Uri(bulkcaller bulk.BulkCaller, opts *bind.CallOpts, id *big.Int) (*string, *error) {

	if opts == nil {
		opts = new(bind.CallOpts)
	}
	__request := _IERC1155MetadataURI.contract.GenRequest(opts, "uri", id)
	...
	outDecoder := func(rawOut []byte) error {
		out := []interface{}{}
		err := _IERC1155MetadataURI.contract.DecodeOutput(&out, rawOut, "uri")
		if err != nil {
			return err
		}
...
func (_IERC1155MetadataURI *IERC1155MetadataURITransactor) SafeBatchTransferFrom(opts *bind.TransactOpts, from common.Address, to common.Address, ids []*big.Int, values []*big.Int, data []byte) (*types.UnsignedTransaction, *types.Hash, error) {
...
//
// Solidity: function safeBatchTransferFrom(address from, address to, uint256[] ids, uint256[] values, bytes data) returns()
func (_IERC1155MetadataURI *IERC1155MetadataURIBulkTransactor) SafeBatchTransferFrom(opts *bind.TransactOpts, from common.Address, to common.Address, ids []*big.Int, values []*big.Int, data []byte) types.UnsignedTransaction {
	return _IERC1155MetadataURI.contract.GenUnsignedTransaction(opts, "safeBatchTransferFrom", from, to, ids, values, data)
}

// SafeBatchTransferFrom is a paid mutator transaction binding the contract method 0x2eb2c2d6.
//
// Solidity: function safeBatchTransferFrom(address from, address to, uint256[] ids, uint256[] values, bytes data) returns()
func (_IERC1155MetadataURI *IERC1155MetadataURISession) SafeBatchTransferFrom(from common.Address, to common.Address, ids []*big.Int, values []*big.Int, data []byte) (*types.UnsignedTransaction, *types.Hash, error) {
...
//
// Solidity: function safeBatchTransferFrom(address from, address to, uint256[] ids, uint256[] values, bytes data) returns()
func (_IERC1155MetadataURI *IERC1155MetadataURITransactorSession) SafeBatchTransferFrom(from common.Address, to common.Address, ids []*big.Int, values []*big.Int, data []byte) (*types.UnsignedTransaction, *types.Hash, error) {
	return _IERC1155MetadataURI.Contract.SafeBatchTransferFrom(&_IERC1155MetadataURI.TransactOpts, from, to, ids, values, data)
}
...
func (_IERC1155MetadataURI *IERC1155MetadataURITransactor) SafeTransferFrom(opts *bind.TransactOpts, from common.Address, to common.Address, id *big.Int, value *big.Int, data []byte) (*types.UnsignedTransaction, *types.Hash, error) {
...
//
// Solidity: function safeTransferFrom(address from, address to, uint256 id, uint256 value, bytes data) returns()
func (_IERC1155MetadataURI *IERC1155MetadataURIBulkTransactor) SafeTransferFrom(opts *bind.TransactOpts, from common.Address, to common.Address, id *big.Int, value *big.Int, data []byte) types.UnsignedTransaction {
	return _IERC1155MetadataURI.contract.GenUnsignedTransaction(opts, "safeTransferFrom", from, to, id, value, data)
}

// SafeTransferFrom is a paid mutator transaction binding the contract method 0xf242432a.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 id, uint256 value, bytes data) returns()
func (_IERC1155MetadataURI *IERC1155MetadataURISession) SafeTransferFrom(from common.Address, to common.Address, id *big.Int, value *big.Int, data []byte) (*types.UnsignedTransaction, *types.Hash, error) {
...
//
// Solidity: function safeTransferFrom(address from, address to, uint256 id, uint256 value, bytes data) returns()
func (_IERC1155MetadataURI *IERC1155MetadataURITransactorSession) SafeTransferFrom(from common.Address, to common.Address, id *big.Int, value *big.Int, data []byte) (*types.UnsignedTransaction, *types.Hash, error) {
	return _IERC1155MetadataURI.Contract.SafeTransferFrom(&_IERC1155MetadataURI.TransactOpts, from, to, id, value, data)
}
...
func (_IERC1155MetadataURI *IERC1155MetadataURITransactor) SetApprovalForAll(opts *bind.TransactOpts, operator common.Address, approved bool) (*types.UnsignedTransaction, *types.Hash, error) {
...
//
// Solidity: function setApprovalForAll(address operator, bool approved) returns()
func (_IERC1155MetadataURI *IERC1155MetadataURIBulkTransactor) SetApprovalForAll(opts *bind.TransactOpts, operator common.Address, approved bool) types.UnsignedTransaction {
	return _IERC1155MetadataURI.contract.GenUnsignedTransaction(opts, "setApprovalForAll", operator, approved)
}

// SetApprovalForAll is a paid mutator transaction binding the contract method 0xa22cb465.
//
// Solidity: function setApprovalForAll(address operator, bool approved) returns()
func (_IERC1155MetadataURI *IERC1155MetadataURISession) SetApprovalForAll(operator common.Address, approved bool) (*types.UnsignedTransaction, *types.Hash, error) {
...
//
// Solidity: function setApprovalForAll(address operator, bool approved) returns()
func (_IERC1155MetadataURI *IERC1155MetadataURITransactorSession) SetApprovalForAll(operator common.Address, approved bool) (*types.UnsignedTransaction, *types.Hash, error) {
	return _IERC1155MetadataURI.Contract.SetApprovalForAll(&_IERC1155MetadataURI.TransactOpts, operator, approved)
}
...
// IERC1155MetadataURIApprovalForAllOrChainReorg represents a ApprovalForAll subscription event raised by the IERC1155MetadataURI contract.
type IERC1155MetadataURIApprovalForAllOrChainReorg struct {
	Event      *IERC1155MetadataURIApprovalForAll
...
func (_IERC1155MetadataURI *IERC1155MetadataURIFilterer) FilterApprovalForAll(opts *bind.FilterOpts, account []common.Address, operator []common.Address) (*IERC1155MetadataURIApprovalForAllIterator, error) {
	...
	logs, err := _IERC1155MetadataURI.contract.FilterLogs(opts, "ApprovalForAll", accountRule, operatorRule)
	if err != nil {
		return nil, err
	}
	return &IERC1155MetadataURIApprovalForAllIterator{contract: _IERC1155MetadataURI.contract, event: "ApprovalForAll", logs: logs}, nil
}

// WatchApprovalForAll is a free log subscription operation binding the contract event 0x17307eab39ab6107e8899845ad3d59bd9653f200f220920489ca2b5937696c31.
//
// Solidity: event ApprovalForAll(address indexed account, address indexed operator, bool approved)
func (_IERC1155MetadataURI *IERC1155MetadataURIFilterer) WatchApprovalForAll(opts *bind.WatchOpts, sink chan<- *IERC1155MetadataURIApprovalForAllOrChainReorg, account []common.Address, operator []common.Address) (event.Subscription, error) {
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(IERC1155MetadataURIApprovalForAllOrChainReorg)
				event.Event = new(IERC1155MetadataURIApprovalForAll)

				if log.ChainReorg == nil {
					if err := _IERC1155MetadataURI.contract.UnpackLog(event.Event, "ApprovalForAll", *log.Log); err != nil {
						return err
					}
...
// IERC1155MetadataURITransferBatchOrChainReorg represents a TransferBatch subscription event raised by the IERC1155MetadataURI contract.
type IERC1155MetadataURITransferBatchOrChainReorg struct {
	Event      *IERC1155MetadataURITransferBatch
	ChainReorg *types.ChainReorg
}
...
func (_IERC1155MetadataURI *IERC1155MetadataURIFilterer) FilterTransferBatch(opts *bind.FilterOpts, operator []common.Address, from []common.Address, to []common.Address) (*IERC1155MetadataURITransferBatchIterator, error) {
	...
	logs, err := _IERC1155MetadataURI.contract.FilterLogs(opts, "TransferBatch", operatorRule, fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return &IERC1155MetadataURITransferBatchIterator{contract: _IERC1155MetadataURI.contract, event: "TransferBatch", logs: logs}, nil
}

// WatchTransferBatch is a free log subscription operation binding the contract event 0x4a39dc06d4c0dbc64b70af90fd698a233a518aa5d07e595d983b8c0526c8f7fb.
//
// Solidity: event TransferBatch(address indexed operator, address indexed from, address indexed to, uint256[] ids, uint256[] values)
func (_IERC1155MetadataURI *IERC1155MetadataURIFilterer) WatchTransferBatch(opts *bind.WatchOpts, sink chan<- *IERC1155MetadataURITransferBatchOrChainReorg, operator []common.Address, from []common.Address, to []common.Address) (event.Subscription, error) {
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IERC1155MetadataURITransferBatchOrChainReorg)
				event.Event = new(IERC1155MetadataURITransferBatch)

				if log.ChainReorg == nil {
					if err := _IERC1155MetadataURI.contract.UnpackLog(event.Event, "TransferBatch", *log.Log); err != nil {
						return err
					}
					event.Event.Raw = *log.Log
				} else {
...
// IERC1155MetadataURITransferSingleOrChainReorg represents a TransferSingle subscription event raised by the IERC1155MetadataURI contract.
type IERC1155MetadataURITransferSingleOrChainReorg struct {
	Event      *IERC1155MetadataURITransferSingle
	ChainReorg *types.ChainReorg
}
...
func (_IERC1155MetadataURI *IERC1155MetadataURIFilterer) FilterTransferSingle(opts *bind.FilterOpts, operator []common.Address, from []common.Address, to []common.Address) (*IERC1155MetadataURITransferSingleIterator, error) {
	...
	logs, err := _IERC1155MetadataURI.contract.FilterLogs(opts, "TransferSingle", operatorRule, fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return &IERC1155MetadataURITransferSingleIterator{contract: _IERC1155MetadataURI.contract, event: "TransferSingle", logs: logs}, nil
}

// WatchTransferSingle is a free log subscription operation binding the contract event 0xc3d58168c5ae7397731d063d5bbf3d657854427343f4c083240f7aacaa2d0f62.
//
// Solidity: event TransferSingle(address indexed operator, address indexed from, address indexed to, uint256 id, uint256 value)
func (_IERC1155MetadataURI *IERC1155MetadataURIFilterer) WatchTransferSingle(opts *bind.WatchOpts, sink chan<- *IERC1155MetadataURITransferSingleOrChainReorg, operator []common.Address, from []common.Address, to []common.Address) (event.Subscription, error) {
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IERC1155MetadataURITransferSingleOrChainReorg)
				event.Event = new(IERC1155MetadataURITransferSingle)

				if log.ChainReorg == nil {
					if err := _IERC1155MetadataURI.contract.UnpackLog(event.Event, "TransferSingle", *log.Log); err != nil {
						return err
					}
					event.Event.Raw = *log.Log
				} else {
...
// IERC1155MetadataURIURIOrChainReorg represents a URI subscription event raised by the IERC1155MetadataURI contract.
type IERC1155MetadataURIURIOrChainReorg struct {
	Event      *IERC1155MetadataURIURI
	ChainReorg *types.ChainReorg
}
...
func (_IERC1155MetadataURI *IERC1155MetadataURIFilterer) FilterURI(opts *bind.FilterOpts, id []*big.Int) (*IERC1155MetadataURIURIIterator, error) {
	...
	logs, err := _IERC1155MetadataURI.contract.FilterLogs(opts, "URI", idRule)
	if err != nil {
		return nil, err
	}
	return &IERC1155MetadataURIURIIterator{contract: _IERC1155MetadataURI.contract, event: "URI", logs: logs}, nil
}

// WatchURI is a free log subscription operation binding the contract event 0x6bb7ff708619ba0610cba295a58592e0451dee2622938c8755667688daf3529b.
//
// Solidity: event URI(string value, uint256 indexed id)
func (_IERC1155MetadataURI *IERC1155MetadataURIFilterer) WatchURI(opts *bind.WatchOpts, sink chan<- *IERC1155MetadataURIURIOrChainReorg, id []*big.Int) (event.Subscription, error) {
	...
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IERC1155MetadataURIURIOrChainReorg)
				event.Event = new(IERC1155MetadataURIURI)

				if log.ChainReorg == nil {
					if err := _IERC1155MetadataURI.contract.UnpackLog(event.Event, "URI", *log.Log); err != nil {
						return err
					}
					event.Event.Raw = *log.Log
				} else {
